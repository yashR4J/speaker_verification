...
Authors
 * Hwidong Na 2020 (ECAPA-TDNN)
 * Nauman Dawalatabad 2020 (X-VECTOR + CLASSIFIER)
 * Mirco Ravanelli 2020 (X-VECTOR + CLASSIFIER)
"""
...
class Classifier(sb.nnet.containers.Sequential):
    ...
    def __init__(
        ...
        self.append(_BatchNorm1d, layer_name="norm")
